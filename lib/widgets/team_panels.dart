...
/// Team list panel with vibrant gradients for teams list page
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return FutureBuilder<Team?>(
      ...
      builder: (context, snapshot) {
        ...
        // Use team colors if available (same logic as TeamBrandedPanel)
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Row(
                    children: [
                      // Team Logo (same style as TeamBrandedPanel)
                      Container(
