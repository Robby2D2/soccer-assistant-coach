  ...
  static List<FormationTemplate> getTemplates() {
    return [
      ...
      const FormationTemplate(
        ...
        abbreviations: ['GK', 'RB', 'LB', 'RM', 'CM', 'LM', 'ST'],
      ),
      const FormationTemplate(
        name: '7v7 - 3-2-1',
        playerCount: 7,
        ...
        abbreviations: ['GK', 'RB', 'CB', 'LB', 'RM', 'LM', 'ST'],
      ),
      const FormationTemplate(
        name: '7v7 - 2-1-2-1',
        playerCount: 7,
        ...
        abbreviations: ['GK', 'RB', 'LB', 'DM', 'RAM', 'LAM', 'ST'],
      ),
      const FormationTemplate(
        name: '9v9 - 3-2-3',
        playerCount: 9,
        ...
        abbreviations: ['GK', 'RB', 'CB', 'LB', 'RM', 'LM', 'RF', 'CF', 'LF'],
      ),
      const FormationTemplate(
        name: '9v9 - 3-3-2',
        playerCount: 9,
        ...
        abbreviations: ['GK', 'RB', 'CB', 'LB', 'RM', 'CM', 'LM', 'RST', 'LST'],
      ),
      const FormationTemplate(
        name: '9v9 - 2-3-3',
        playerCount: 9,
        ...
        abbreviations: ['GK', 'RB', 'LB', 'RM', 'CM', 'LM', 'RF', 'CF', 'LF'],
      ),
    ];
  }
}
