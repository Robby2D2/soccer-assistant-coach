...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get mostRecentGame => 'Match le plus récent';

  @override
  String get nextGame => 'Prochain match';

  @override
  String get createNewGame => 'Créer un nouveau match';

  @override
  String get noRecentGamesYet => 'Aucun match joué pour le moment';

  @override
  String get noUpcomingGames => 'Aucun match à venir programmé';
  ...
  @override
  String get orPasteCsvBelow => 'Ou coller le CSV ci-dessous :';
  ...
  String confirmImportUpdate(int count) {
    return 'Mettre à jour $count joueurs (numéro de maillot)';
  }

  @override
  String confirmImportArchive(int count) {
    return 'Archiver $count joueurs (plus dans l\'effectif)';
  }
