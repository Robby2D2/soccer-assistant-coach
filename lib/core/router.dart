...
final router = GoRouter(
  routes: [
    ...
    GoRoute(path: '/team/:id', builder: (_, s) => TeamDetailScreen(id: int.parse(s.pathParameters['id']!))),
    ...
    GoRoute(path: '/game/:id/metrics', builder: (_, s) => MetricsScreen(gameId: int.parse(s.pathParameters['id']!))),
    GoRoute(path: '/game/:id/formation', builder: (_, s) => FormationSelectionScreen(gameId: int.parse(s.pathParameters['id']!))),
    GoRoute(path: '/game/:id/attendance', builder: (_, s) => AttendanceScreen(gameId: int.parse(s.pathParameters['id']!))),
  ],
);
