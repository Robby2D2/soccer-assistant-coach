      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 12),
            SwitchListTile(value: _present, title: const Text('Present'), onChanged: (v) => setState(() => _present = v)),
            ...
            FilledButton.icon(
              ...
              onPressed: () async {
                ...
                await db.updatePlayer(id: widget.playerId, firstName: f, lastName: l, isPresent: _present);
