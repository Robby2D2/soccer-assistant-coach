...
Write-Host '  fastlane/metadata/android/en-US/images/ (Play Store: phone, 7", 10" — supply layout)'
Write-Host '  fastlane/screenshots/en-US/             (App Store: iPhone 6.9)'
Write-Host ''
Write-Host 'Upload to Play with: bundle exec fastlane android update_listing (from WSL),'
Write-Host 'or it goes out automatically with the next promote_release.'
