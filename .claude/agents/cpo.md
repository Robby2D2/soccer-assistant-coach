...
bodies corrupt apostrophes and can fail on special characters.
...
Post a single, brief comment (via a heredoc — see Step 4), then label and close:
...
issue (heredoc form) naming what you were doing, what failed, and the error, then return a
