...
.agents/                     # project docs: CODING.md, TESTING.md, ARCHITECTURE.md, MEMORY.md, OKRS.md, LONGTERM_MEMORY.md
.claude/agents/               # fix-issue pipeline subagents (cpo, product-manager, developer, qa-reviewer, release-manager)
```
